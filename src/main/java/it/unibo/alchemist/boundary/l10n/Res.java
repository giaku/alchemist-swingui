...
public enum Res {
	...
	private final static String english(final Res r) {
		...
		case OPEN:
			return "Open...";
		case OPEN_SAPERE_VIEW:
			return "Open SAPERE perspective";
